...
##sharp decrease in test MSE for 5 comp
...
##We have performed ridge and PCR as remedial measures of multicollinearity. However we see that there is no substantial improvement in rmse. Whereas using Variable selection algorithm, we are getting a better rmse and hence a better model
